...
- Everyday words. If a five-year-old would not use it, do not use it.
- Repeat the key word often. Repetition is the teaching, not a flaw.
...
- Bright, soft, even daylight. Cheerful colours. Simple uncluttered backgrounds.
- Never ask for on-screen text, letters, numbers as writing, logos, or signs —
  they render as nonsense.
...
- Thumbnail text: 2-4 words, very simple.
